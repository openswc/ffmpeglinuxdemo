/**
 * file: simplest_ffmpeg_avutil.cpp
 * Simplest FFmpeg AVUtil
 *
 * Author: Lei Xiaohua
 * Modify: openswc
 *
 * the example of FFmpeg's libavutil:
 * AVLog
 * AVOption (AVClass)
 * AVDictionary
 * ParseUtil
 ...
 * ParseUtil 
 *
 * gcc simplest_ffmpeg_avutil.cpp -I./ffmpeg_build/include/ -L./ffmpeg_build/lib/ -lavutil -lavcodec -lavformat -o sffavutil
 * gcc simplest_ffmpeg_avutil.cpp -I./ffmpeg_build/include/ -L./ffmpeg_build/lib/ -lavformat -lavcodec -lswresample -lavutil -pthread -lva -lm -lz -o sffavutil
 * gcc simplest_ffmpeg_avutil.cpp -I /home/wr/temp/ffmpeg-release-3.0/ffmpeg_build/include -L /home/wr/temp/ffmpeg-release-3.0/ffmpeg_build/lib -lavformat -lavcodec -lswresample -lavutil -pthread -lva -lm -lz -o sffavutil
 */
